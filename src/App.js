          ...
          <div className="App">
            ...
            >
              <div className="navbar-brand">
                <b className="navbar-item is-size-4 ">BlacArt
                </b>
                <a
                  href="/"
                  role="button"
              ...
              >
                <Link to="/">
                   ...
                   srs="https://i.pinimg.com/originals/cb/92/f2/cb92f275d0910e502bfbffdba4bddfd1.jpg"
                   alt=""
                   />
              </Link>
                <input type="text" className="header__searchInput"/>
                <SearchIcon className="head__searchicon"/>
